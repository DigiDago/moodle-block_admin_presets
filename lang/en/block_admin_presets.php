...
$string['deletepreviouslyapplied'] =
        'This preset has been previously applied, if you delete it you can not return to the previous state';
$string['deleteexecute'] = 'execution';
$string['deleteshow'] = 'confirm';
$string['errorupgradetablenames'] =
        'admin_presets upgrade failed, upgrade Moodle in order to upgrade admin_presets. You can restore the previous blocks/admin_presets code until then';
$string['errorupgradetablenamesdebug'] =
        'The table names exceeds the limit of allowed characters, this is solved using the latest Moodle 2.0, Moodle 2.1 and Moodle 2.2 releases';
