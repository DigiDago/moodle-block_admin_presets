...
class block_admin_presets extends block_list {
    ...
    public function get_content() {
        ...
        $temp = '<img src="'.
                    $OUTPUT->image_url("i/backup").
                    '" class="icon" alt="'.get_string('actionexport', 'block_admin_presets').
                '" />';
        ...
        $this->content->items[] = '<img src="'.
            $OUTPUT->image_url("i/restore").
            '" class="icon" alt="'.get_string('actionimport', 'block_admin_presets').
